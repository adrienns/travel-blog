...
import VisitBeachesSection from "./VisitBeachesSection";
import CavesSection from "./VisitCavesSection";
import DivingSnorkelingSection from "./DivingSnorkelingSection";
import OtherActivitiesSection from "./OtherActivitiesSection";
import VisitOtherIslandsSection from "./VisitOtherIslandsSection";


const AccomodationMap = dynamic(() => import("./MaratuaMap"), {
  ssr: false,
  loading: () => <div className="h-full w-full bg-neutral-200 animate-pulse flex items-center justify-center">Loading map…</div>
});
...
export default function TravelBlogLandingClient({ stays }) {
  return (
